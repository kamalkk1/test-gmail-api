...
git clone https://github.com/kamalkk1/test-gmail-api.git
...
<h3> <a href = "https://github.com/kamalkk1/test-gmail-api.git"> CODE</a> </h3><br>
...
3.User-specific configuration: Making the code more flexible by allowing users to provide their own
...
4.Time Monitoring: The code currently use randominterval function to generate seconds and in this code can be improved by adding cron jobs package to schedule email tasks 
